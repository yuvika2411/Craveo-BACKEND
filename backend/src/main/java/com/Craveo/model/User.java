...
public class User {
    ...
    // RestaurantDto is @Embeddable so @ElementCollection is correct here
    @ElementCollection
    private List<RestaurantDto> favorites = new ArrayList<>();

    // Address is a full @Entity so @OneToMany is correct here — removed conflicting @ElementCollection
